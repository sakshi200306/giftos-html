    ...
    <div id="page-inner">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <a type="button" class="btn btn-secondary" href="categary_add.php">Add Categary</a>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="form-inline">
            <div class="input-group" data-widget="sidebar-search">
                <form>
                    <input class="form-control" name="categary_Name" type="search" placeholder="Search" value="<?= isset($_GET["categary_Name"]) ? $_GET["categary_Name"] : "" ?>">
                </form>
                ...
                <table class="table table-bordered text-center">
                    ...
                    ?>  
                        <tr>
                            ...
                            <td> <?= $row["dis"] ?> </td>
                            <td>
                                <a href="categaryview.php?categary_id=<?= $row["id"] ?>" class="btn btn-sm mx-1 btn-outline-info">
                                    <i class="fa fa-eye"></i> View
                                </a>
                                <a href="categaryedit.php?categary_id=<?= $row["id"] ?>" class="btn btn-sm mx-1 btn-outline-success">
                                    <i class="fa fa-pen"></i> Edit
                                </a>
                                <a href="categarydelete.php?categary_id=<?= $row["id"] ?>" class="btn btn-sm mx-1 btn-outline-danger">
